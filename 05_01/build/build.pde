...
void draw() {
	...
	_child1.beginDraw();
		...
		_child1.push();
			...
			// for (int x = 0; x < _w + 20; x = x + 20) {
			// 	_child1.stroke(#222222);
			// 	_child1.line(x, 0, x, _h);
			// }

			// for (int y = 0; y < _w + 20; y = y + 20) {
			// 	_child1.stroke(#222222);
			// 	_child1.line(0, y, _w, y);
			// }
			...
			_child1.noFill();
			_child1.stroke(cyan);
			_child1.line(0, lineLength * -1, 0, 0, lineLength, 0);
			_child1.stroke(cyan);
			_child1.line(lineLength * -1, 0, 0, lineLength, 0, 0);
			_child1.stroke(cyan);
			_child1.line(0, 0, lineLength * -1, 0, 0, lineLength);
			_child1.noFill();
			_child1.stroke(pink);
			_child1.box(boxSize + 20);
			_child1.fill(fg);
			_child1.noStroke();
			_child1.box(boxSize);
	...
	_child2.beginDraw();
		// _child2.clear();
		_child2.background(bg);
		_child2.noFill();
		_child2.noStroke();
		_child2.push();
			for (int x = 0; x < _w + 20; x = x + 20) {
				_child2.stroke(#222222);
				_child2.line(x, 0, x, _h);
			}

			for (int y = 0; y < _w + 20; y = y + 20) {
				_child2.stroke(#222222);
				_child2.line(0, y, _w, y);
			}
